...
public:
	...
	void OnRangeWeaponTargetDataReady(const FGameplayAbilityTargetDataHandle& InTargetData);
...
protected:
	...
	void OnTargetDataReadyCallback(const FGameplayAbilityTargetDataHandle& InTargetData, FGameplayTag InTag);
